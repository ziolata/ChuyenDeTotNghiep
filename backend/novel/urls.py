...
urlpatterns = [
    ...
    path('list-page/', views.NovelList_Page.as_view(), name='Novel List'),
    ...
    path('list/random/', views.NovelRandomView.as_view(), name='Novel Random'),
    ...
    path('history/', views.ReadingHistoryListCreateView.as_view(), name='history'),
